...
CREATE TABLE `aowow_achievement` (
  ...
  `reward_loc4` varchar(92) NOT NULL,
...
CREATE TABLE `aowow_achievementcriteria` (
  ...
  `name_loc4` varchar(128) NOT NULL,
...
CREATE TABLE `aowow_currencies` (
  ...
  `description_loc4` varchar(256) NOT NULL,
...
CREATE TABLE `aowow_emotes` (
  ...
  `target_loc4` varchar(95) DEFAULT NULL,
  ...
  `noTarget_loc4` varchar(85) DEFAULT NULL,
  ...
  `self_loc4` varchar(85) DEFAULT NULL,
...
CREATE TABLE `aowow_home_featuredbox_overlay` (
  ...
  `title_loc4` varchar(100) NOT NULL DEFAULT '',
...
CREATE TABLE `aowow_itemrandomenchant` (
  ...
  `name_loc4` varchar(250) NOT NULL,
...
CREATE TABLE `aowow_itemset` (
  ...
  `bonusText_loc4` varchar(256) NOT NULL,
...
CREATE TABLE `aowow_mailtemplate` (
  ...
  `subject_loc4` varchar(128) NOT NULL,
...
CREATE TABLE `aowow_sourcestrings` (
  ...
  `source_loc4` varchar(128) NOT NULL,
...
CREATE TABLE `aowow_titles` (
  ...
  `female_loc4` varchar(39) NOT NULL,
...
CREATE TABLE `aowow_zones` (
  ...
  `name_loc4` varchar(120) NOT NULL,
