...
CLISetup::registerSetup("sql", new class extends SetupScript
{
    ...
    protected array $setupAfter      = [['icons', 'spellrange'], []]; // spellrange required to use SpellEntry
    ...
    public function generate() : bool
    {
        $ssQuery = 'SELECT id,
                           ...
                           Targets,
                           0 AS spellFocus,
                           0 AS casterAuraSpell,    0 AS targetAuraSpell,
                           0 AS casterAuraSpellNot, 0 AS targetAuraSpellNot,
        ...
        $baseQry = 'SELECT    s.id,
                              ...
                              casterAuraSpellNot, targetAuraSpellNot,
