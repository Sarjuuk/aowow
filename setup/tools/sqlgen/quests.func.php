...
function quests(array $ids = [])
{
    $baseQuery = '
        SELECT
            ...
            LogTitle,                           IFNULL(lq.Title_loc2, ""),              IFNULL(lq.Title_loc3, ""),              IFNULL(lq.Title_loc4, ""),              IFNULL(lq.Title_loc6, ""),              IFNULL(lq.Title_loc8, ""),
            LogDescription,                     IFNULL(lq.Objectives_loc2, ""),         IFNULL(lq.Objectives_loc3, ""),         IFNULL(lq.Objectives_loc4, ""),         IFNULL(lq.Objectives_loc6, ""),         IFNULL(lq.Objectives_loc8, ""),
            QuestDescription,                   IFNULL(lq.Details_loc2, ""),            IFNULL(lq.Details_loc3, ""),            IFNULL(lq.Details_loc4, ""),            IFNULL(lq.Details_loc6, ""),            IFNULL(lq.Details_loc8, ""),
            AreaDescription,                    IFNULL(lq.EndText_loc2, ""),            IFNULL(lq.EndText_loc3, ""),            IFNULL(lq.EndText_loc4, ""),            IFNULL(lq.EndText_loc6, ""),            IFNULL(lq.EndText_loc8, ""),
            IFNULL(qor.RewardText, ""),         IFNULL(lq.OfferRewardText_loc2, ""),    IFNULL(lq.OfferRewardText_loc3, ""),    IFNULL(lq.OfferRewardText_loc4, ""),    IFNULL(lq.OfferRewardText_loc6, ""),    IFNULL(lq.OfferRewardText_loc8, ""),
            IFNULL(qri.CompletionText, ""),     IFNULL(lq.RequestItemsText_loc2, ""),   IFNULL(lq.RequestItemsText_loc3, ""),   IFNULL(lq.RequestItemsText_loc4, ""),   IFNULL(lq.RequestItemsText_loc6, ""),   IFNULL(lq.RequestItemsText_loc8, ""),
            QuestCompletionLog,                 IFNULL(lq.CompletedText_loc2, ""),      IFNULL(lq.CompletedText_loc3, ""),      IFNULL(lq.CompletedText_loc4, ""),      IFNULL(lq.CompletedText_loc6, ""),      IFNULL(lq.CompletedText_loc8, ""),
            ...
            ObjectiveText1,                     IFNULL(lq.ObjectiveText1_loc2, ""),     IFNULL(lq.ObjectiveText1_loc3, ""),     IFNULL(lq.ObjectiveText1_loc4, ""),     IFNULL(lq.ObjectiveText1_loc6, ""),     IFNULL(lq.ObjectiveText1_loc8, ""),
            ObjectiveText2,                     IFNULL(lq.ObjectiveText2_loc2, ""),     IFNULL(lq.ObjectiveText2_loc3, ""),     IFNULL(lq.ObjectiveText2_loc4, ""),     IFNULL(lq.ObjectiveText2_loc6, ""),     IFNULL(lq.ObjectiveText2_loc8, ""),
            ObjectiveText3,                     IFNULL(lq.ObjectiveText3_loc2, ""),     IFNULL(lq.ObjectiveText3_loc3, ""),     IFNULL(lq.ObjectiveText3_loc4, ""),     IFNULL(lq.ObjectiveText3_loc6, ""),     IFNULL(lq.ObjectiveText3_loc8, ""),
            ObjectiveText4,                     IFNULL(lq.ObjectiveText4_loc2, ""),     IFNULL(lq.ObjectiveText4_loc3, ""),     IFNULL(lq.ObjectiveText4_loc4, ""),     IFNULL(lq.ObjectiveText4_loc6, ""),     IFNULL(lq.ObjectiveText4_loc8, "")
        FROM
            quest_template q
        LEFT JOIN
