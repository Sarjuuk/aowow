...
function items(array $ids = [])
{
    $baseQuery = '
        SELECT
            ...
            name,                   name_loc2,              name_loc3,              name_loc4,              name_loc6,              name_loc8,
            displayid,
            Quality,
            Flags,                  FlagsExtra,
            ...
            bonding,
            it.description,         description_loc2,       description_loc3,       description_loc4,       description_loc6,       description_loc8,
            PageText,
            LanguageID,
            startquest,
            lockid,
