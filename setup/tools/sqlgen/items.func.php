...
function items(array $ids = [])
{
    $baseQuery = '
        SELECT
            ...
            name,                   IFNULL(li.name_loc2, ""), IFNULL(li.name_loc3, ""), IFNULL(li.name_loc4, ""), IFNULL(li.name_loc6, ""), IFNULL(li.name_loc8, ""),
            0 AS iconId,
            displayid,
            0 AS spellVisualId,
            Quality,
            ...
            bonding,
            it.description,         IFNULL(li.description_loc2, ""), IFNULL(li.description_loc3, ""), IFNULL(li.description_loc4, ""), IFNULL(li.description_loc6, ""), IFNULL(li.description_loc8, ""),
            PageText,
            LanguageID,
            startquest,
            lockid,
