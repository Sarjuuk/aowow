    ...
    public function generate() : bool
    {
        $baseQuery =
           'SELECT    q.ID,
                      ...
                      q.LogTitle,                         IFNULL(qtl2.LogTitle, ""),           IFNULL(qtl3.LogTitle, ""),           IFNULL(qtl4.LogTitle, ""),           IFNULL(qtl6.LogTitle, ""),           IFNULL(qtl8.LogTitle, ""),
                      q.LogDescription,                   IFNULL(qtl2.LogDescription, ""),     IFNULL(qtl3.LogDescription, ""),     IFNULL(qtl4.LogDescription, ""),     IFNULL(qtl6.LogDescription, ""),     IFNULL(qtl8.LogDescription, ""),
                      q.QuestDescription,                 IFNULL(qtl2.QuestDescription, ""),   IFNULL(qtl3.QuestDescription, ""),   IFNULL(qtl4.QuestDescription, ""),   IFNULL(qtl6.QuestDescription, ""),   IFNULL(qtl8.QuestDescription, ""),
                      q.AreaDescription,                  IFNULL(qtl2.AreaDescription, ""),    IFNULL(qtl3.AreaDescription, ""),    IFNULL(qtl4.AreaDescription, ""),    IFNULL(qtl6.AreaDescription, ""),    IFNULL(qtl8.AreaDescription, ""),
                      ...
                      q.QuestCompletionLog,               IFNULL(qtl2.QuestCompletionLog, ""), IFNULL(qtl3.QuestCompletionLog, ""), IFNULL(qtl4.QuestCompletionLog, ""), IFNULL(qtl6.QuestCompletionLog, ""), IFNULL(qtl8.QuestCompletionLog, ""),
