...
final class CLISetup
{
    ...
    public const int LOCK_OFF      = 0;
    public const int LOCK_ON       = 1;
    public const int LOCK_RESTORE  = 2;

    public const int ARGV_NONE     = 0x00;
    public const int ARGV_REQUIRED = 0x01;
    public const int ARGV_OPTIONAL = 0x02;
    public const int ARGV_PARAM    = 0x04;                  // parameter to another argument
    public const int ARGV_ARRAY    = 0x10;                  // arg accepts list of values

    public const int OPT_GRP_SETUP = 0;
    public const int OPT_GRP_UTIL  = 1;
    public const int OPT_GRP_MISC  = 2;
    ...
    private static array $optGroups       = ['AoWoW Setup', 'Utility Functions', 'Additional Options'];
    private static array $optDefs         = array(          // cmd => [groupId, aliases[], argvFlags, description, appendix]
