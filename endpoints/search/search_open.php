...
class SearchOpenResponse extends TextResponse implements ICache
{
    ...
    private const /* int */ SEARCH_MODS_OPEN = 1 << Search::MOD_CLASS    | 1 << Search::MOD_RACE     | 1 << Search::MOD_TITLE   | 1 << Search::MOD_WORLDEVENT  |
                                               ...
                                               1 << Search::MOD_ZONE     | 1 << Search::MOD_OBJECT   | 1 << Search::MOD_FACTION | 1 << Search::MOD_SKILL       | 1 << Search::MOD_PET;
    ...
    protected function generate() : void
    {
        ...
        foreach ($this->searchObj->perform() as [$data, [$type, $nMatches, $param1, $param2]])
        {
