...
class ItemBaseResponse extends TemplateResponse implements ICache
{
    ...
    protected function generate() : void
    {
        ...
        // pageText
        $this->book = Game::getBook($this->subject->getField('pageTextId'));
        ...
        $this->redButtons = array(
            ...
            BUTTON_COMPARE => in_array($_class, [ITEM_CLASS_WEAPON, ITEM_CLASS_ARMOR, ITEM_CLASS_GEM]),
            BUTTON_EQUIP   => in_array($_class, [ITEM_CLASS_WEAPON, ITEM_CLASS_ARMOR]),
            BUTTON_UPGRADE => in_array($_class, [ITEM_CLASS_WEAPON, ITEM_CLASS_ARMOR, ITEM_CLASS_GEM]) ? ['class' => $_class, 'slot' => $_slot] : false,
            BUTTON_LINKS   => array(
