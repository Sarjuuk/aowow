...
{
    protected array  $expectedGET    = ['compare'        => ['filter' => FILTER_CALLBACK, 'options' => [self::class, 'checkCompareString']]];
    protected array  $expectedCOOKIE = ['compare_groups' => ['filter' => FILTER_CALLBACK, 'options' => [self::class, 'checkCompareString']]];
