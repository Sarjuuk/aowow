...
class TitleBaseResponse extends TemplateResponse implements ICache
{
    ...
    protected function generateMetadata(bool $useArticle = true) : void
    {
        ...
        $nameFixed = Util::ucFirst($this->subject->name);
