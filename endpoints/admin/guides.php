...
class AdminGuidesResponse extends TemplateResponse
{
    ...
    protected function generate() : void
    {
        ...
        else
        {
            ...
            $latest = DB::Aowow()->selectCol('SELECT `typeId` AS ARRAY_KEY, MAX(`rev`) FROM ::articles WHERE `type` = %i AND `typeId` IN %in GROUP BY `typeId`', Type::GUIDE, $pending->getFoundIDs());
