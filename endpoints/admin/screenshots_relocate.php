...
class AdminScreenshotsActionRelocateResponse extends TextResponse
{
    ...
    protected function generate() : void
    {
        ...
        {
            trigger_error(__METHOD__.' - screenshotId or typeId empty', E_USER_E_USER_WARNINGERROR);
            return;
        }
        ...
        if (Type::validateIds($type, $typeId))
        {
            ...
            trigger_error(__METHOD__.' - invalid typeId #'.$typeId.' for type #'.$type, E_USER_WARNING);
    }
}
