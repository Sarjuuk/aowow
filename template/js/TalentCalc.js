...
// *************************************************************
    ...
    function _createTrees(classId) {
        ...
        for (var tree = 0; tree < _nTrees; ++tree) {
            ...
            if (_mode == MODE_PET) {
                d.style.backgroundImage = 'url(' + g_staticUrl + '/images/talent/pets/bg_' + (c[0].i + 1) + '.jpg' + afterUrl + ')';
                iconBg = g_staticUrl + '/images/talent/pets/icons_' + (c[0].i + 1) + '.jpg' + afterUrl
            }
            else {
                d.style.backgroundImage = 'url(' + g_staticUrl + '/images/talent/classes/backgrounds/' + g_file_classes[classId] + '_' + (tree + 1) + '.jpg' + afterUrl + ')';
                iconBg = g_staticUrl + '/images/talent/classes/icons/' + g_file_classes[classId] + '_' + (tree + 1) + '.jpg' + afterUrl;
            }
