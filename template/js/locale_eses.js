...
var mn_community = [
	[3,"Foros","http://forums.battle.net",null,{tinyIcon:"template/images/forum.png"}],
	[7,"Blog","http://worldpress.com",null,{tinyIcon:"template/images/blog.png"}],
	[4,"Canal de IRC","http://webchat.quakenet.org/",null,{tinyIcon:"template/images/bubble.gif"}],
	[,"Social"],
	[6,"Página de Facebook","http://facebook.com",null,{icon:"template/images/facebook.gif"}],
	[5,"Página de Twitter","http://twitter.com",null,{icon:"template/images/twitter.gif"}]
];
var mn_more = [
	[,"Todo sobre Wowhead"],
...
var LANG = {and:" y ",
    ...
    lvnote_questgivers:'Ver <a href="?zone=$1">personajes de misión</a> en <b>$2</b> &nbsp;<b>|</b>&nbsp; Filtrar <a href="?items&filter=cr=126;crs=$3;crv=0">recompensas</a>',
    lvnote_allpets:'Todas las mascotas pueden aprender todas las <a href="?spells=-3.270">habilidades pasivas</a>',
	...
	tooltip_lmwhtfy:'<b class="q">LMWHTFY</b><br />Consigue un enlace LMWHTFY.com para esta búsqueda.',
	...
	tab_latesttopics:"Últimos tópicos",
	...
	tab_skinnedfrom:"Desolló de",
	tab_skinning:"Desollar",
    ...
    cn_entryerror:"Ha ocurrido un error. Por favor, inténtalo de nuevo.",
    ...
    fidropdowns:{
        ...
        resistance:[[6,"Arcano"],[2,"Fuego"],[3,"Naturaleza"],[4,"Escarcha"],[5,"Sombras"],[1,"Sagrado"],[0,"Física"]],
        gem:[[5,"Sí"],[1,"Meta"],[2,"Roja"],[3,"Amarilla"],[4,"Azul"],[6,"No"]],
        profession:[
            [11,"Sí"],
            [1,"Alquimia"],
            [3,"Cocina"],
        ...
        heroicraid:[[4812,"Ciudadela de la Corona de Hielo"],[4722,"Prueba del Cruzado"]],
        multimoderaid:[[4812,"Ciudadela de la Corona de Hielo"],[4500,"El Ojo de la Eternidad"],[4493,"El Sagrario Obsidiana"],[2159,"Guarida de Onyxia"],[4603,"La C\u00e1mara de Archavon"],[3456,"Naxxramas"],[4722,"Prueba del Cruzado"],[4273,"Ulduar"]],
        event:[
            [335,"Amor en el aire"],
            [424,"Competici\u00f3n de pesca Kalu'ak"],
            [398,"D\u00eda de los Piratas"],
            [141,"El fest\u00edn del Festival de Invierno"],
            ...
            [201,"Semana de los Ni\u00f1os"]
        ],
        pvp:[[1,"Sí"],[3,"Arena"],[4,"Campo de batalla"],[5,"Mundo"],[2,"No"]],
        currency:[
            [34597,"Almeja Aleta Invernal"],
            ...
            [38425,"Cuero boreal pesado"],
            [34208,"Cumbrehombros de equilibrio"],
            [29434,"Distintivo de justicia"],
            [45624,"Emblema de conquista"],
            [49426,"Emblema de escarcha"],
            [40752,"Emblema de hero\u00edsmo"],
            [47241,"Emblema de triunfo"],
            [40753,"Emblema de valor"],
            ...
            [43589,"Marca de Honor de Conquista del Invierno"],
            ...
            [37836,"Moneda de Ventura"],
            [34664,"Mota de sol"],
            [41596,"Muestra de joyero de Dalaran"],
            [44128,"Pelaje \u00e1rtico"],
            [26045,"Pieza Halaa de batalla"],
            [26044,"Pieza Halaa de investigaci\u00f3n"],
            [29735,"Polvo sagrado"],
            [43016,"Premio de cocina de Dalaran"],
        ...
        spellsource:[[1,"Cualquiera"],[3,"Creado"],[9,"Descubierto"],[4,"Encontrado"],[6,"Misión"],[10,"Talento"],[8,"Entrenador"],[7,"Vendedor"],[2,"Ninguno"]],
        itemsource:[[1,"Cualquiera"],[3,"Creado"],[4,"Encontrado"],[5,"JcJ"],[6,"Misión"],[8,"Redención"],[7,"Vendedor"],[2,"Ninguno"]],
        glyphtype:[[1,"Sublime"],[2,"Menor"]],
        classs:[[12,"Cualquiera"],[9,"Brujo"],[6,"Caballero de la Muerte"],[3,"Cazador"],[7,"Cham\u00e1n"],[11,"Druida"],[1,"Guerrero"],[8,"Mago"],[2,"Palad\u00edn"],[4,"P\u00edcaro"],[5,"Sacerdote"],[13,"Ninguno"]],
        race:[[12,"Cualquiera"],[11,"Draenei"],[4,"Elfo de la noche"],[10,"Elfo de sangre"],[3,"Enano"],[7,"Gnomo"],[1,"Humano"],[5,"No-muerto"],[2,"Orco"],[6,"Tauren"],[8,"Trol"],[13,"Ninguno"]],
        disenchanting:[
	...
	lvtopic_by:"Por ",
	lvtopic_lastedit:"Última edición en ",
	...
	pr_tt_nodata:"Estas estadísticas no están actualmente disponibles en el juego<br />y no pueden ser registradas por Wowhead.",
	...
	pr_error_armory7:"Fallo al extraer las estadísticas",
	...
	pr_stats_warning:"Atención: Algunas estadísticas (particularmente la esquiva) pueden no ser exactas.",
	pr_stats_title:"Estadísticas",
	pr_stats_base:"Base",
    ...
    pr_statstt_dodgepct:'<span class="q2">Índice de esquiva $1 (+$2% esquiva)</span><br />Aumenta la probabilidad de esquivar en un $3%<br /><span class="q0">(Antes del rendimiento decreciente)</span>',
	...
	pr_statstt_parrypct:'<span class="q2">Índice de parada $1 (+$2% parada)</span><br />Aumenta la probabilidad de parar en un $3%<br /><span class="q0">(Antes del rendimiento decreciente)</span>',
    pr_statstt_resipct:'<span class="q2">Índice de Temple $1 (+$2% temple)</span><br />Reduce el daño periódico y la probabilidad de ser críticamente golpeado en un $3%<br />Reduce el efecto del drenaje de mana y el daño de los golpes críticos en un $4%',
	...
	tc_masterytipdesc:"La rama de talentos en la que te has especializado, otorga 3 bonos que escalan con el número de puntos gastados en esa rama.",
	tc_point:"punto",
	tc_points:"Puntos",
	tc_none:"Ninguno",
