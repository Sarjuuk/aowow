...
// new
    ...
    message_weightscalesaveerror: "Erreur : Votre échelle de valeurs ne peut être enregistrée. Les comptes Wowhead ont une limite de 5 échelles personnalisées. Chaque échelle doit avoir au moins un facteur.",
    ...
    prompt_signaturemarkup: "Copier/Coller ce qui suit dans votre signature Wowhead:",
    ...
    ct_dialog_contactwowhead: "Contactez Wowhead",
    ...
    dialog_collector:"Récompense d'une Édition de Collectionneur",
    ...
    dialog_exclude:"Exclure des entrées vous permets d'enlever les trucs que vous ne pouvez ou ne voulez pas compléter. Les inclusions/exclusions individuelles vont surcharger les catégories rapide ci-dessous.<br /><br />Vos paramètres d'exclusions sont partagés entre tous les personnages.",
    dialog_noexalted:"Impossible d'atteindre exalté",
    dialog_manageexclusions:"Manager les exclusions personnelles",
    ...
    button_claimchar:"Réclamez personnage",
    button_resync:"Resynchronisation",
    ...
    pr_tt_nodata:"Cette statistique n'est présentement pas disponible dans le jeu<br />et ne peut être enregistrée par Wowhead.",
    pr_tt_enchreq:"L'enchantement requière le niveau $1",
    pr_tt_new:'<b class="q">Nouveau</b><br />Crée un nouveau profile personnalisé à partir de rien.',
    pr_tt_saveas:'<b class="q">Sauvegarder sous</b><br />Sauvegarde le profile actuel en tant que profile personnalisé<br />lié à votre compte Wowhead.',
    pr_tt_resync:'<b class="q">Resynchronisation</b><br />Resynchroniser le personnage avec les dernières<br />version disponible de l\'Armurerie',
    ...
    pr_tt_exclude:'<b class="q">Exclure</b><br />Déplacer les entrées sélectionnées dans votre liste d\'exclusions.<br />Ceci peut être utile pour cacher certaines choses que vous ne considéré pas<br />importantes pour atteindre une finalisation de 100%.',
    ...
    pr_tt_questtip:"Les quêtes répétable et les quêtes qui<br />n'apparaissent pas dans votre journal de quête ne sont pas retracées.",
    ...
    pr_tip_quests:'Note: <span class="tip">Certaines</span> quetes ne sont pas retrouvable par les API de Blizzard.',
    ...
    pr_header_figureprint:"Achetez FigurePrint",
    ...
    pr_queue_partial:"<b>Ce personnage a été partiellement récupéré, alors une resynchronisation complète de l'Armurerie a été demandée.</b>",
    ...
    pr_queue_status3:'Le personnage est prêt! <a href="?$3" rel="np">Actualisez le profile</a>',
    pr_queue_status4:'Incapable de resynchroniser avec l\'Armurerie: $1. Essayer <a href="javascript:;">de resynchroniser</a> ce personnage à nouveau.',
    pr_error_armory0:"Erreur inconnue",
    pr_error_armory1:"Le personnage n'existe pas",
    pr_error_armory2:"La récupération du personnage a échouée",
    pr_error_armory3:"La récupération des talents a échouée",
    pr_error_armory4:"La récupération des compétences a échouée",
    pr_error_armory5:"La récupération des réputations a échouée",
    pr_error_armory6:"La récupération des haut-faits a échouée",
    pr_error_armory7:"La récupération des statistiques a échouée",
    pr_error_armory8:"L'Armurerie n'a pu être contactée",
    ...
    pr_stats_warning:"Attention: Certaines statistiques (particulièrement esquive) peut ne pas être entièrement précise.",
    ...
    pr_statstt_armor:"Réduit les dommage physique reçu de $2%",
    pr_statstt_armor2:"Réduit les dommages physiques reçu de $2%<br />Augmente l'armure de votre familier de $1",
    ...
    pr_statstt_blockpct:'<span class="q2">Score de blocage $1 (+$2% de blocage)</span><br />Augmente vos chance de bloquer de  $4%<br />Votre blocage arrête $3 dommage',
    pr_statstt_def:"<span class=\"q2\">Score de défense $1 (+$2 défense)</span><br />Augmente vos chance d'éviter, de bloquer et de parer de $3%<br />Réduit les chances d'être touché et d'être critiquement touché de $4%",
    pr_statstt_dodgepct:"<span class=\"q2\">Score d'évitement $1 (+$2% évitement)</span><br />Augmente les chance d'éviter de $3%",
    pr_statstt_exp:"<span class=\"q2\">Score d'expertise $1 (+$2 expertise)</span><br />Réduit les chance d'être évité ou paré de $3%",
    ...
    pr_statstt_mleatkpwr:"Augmente les dommage avec les armes de corps-à-corps de $1 par seconde",
    ...
    pr_statstt_resipct:'<span class="q2">Score de résilience $1 (+$2% résilience)</span><br />Réduit la probabilité de subir un coup critique de $3%<br />Réduit les effets des drains de mana et les dégâts des coups critiques de $4%<br />Augmente de $5% supplémentaires la réduction de tous les dégâts infligés par les joueurs et leurs familiers ou serviteurs',
    pr_statstt_resist:"Augmente la résistance contre les attaques, sorts et habileté de type $1.<br />Résistance moyenne contre les sorts lancé par un niveau $3: $1%",
    ...
    pr_statstt_spi:"Augmente la régénération de sante de $1 par 5 secondes hors-combat<br />Augmente la régénération de mana de $2 par 5 secondes hors-invocation",
    ...
    pr_statstt_splhitpct:'<span class="q2">Score de touche $1 (+$2% chance de toucher)</span><br />Augmente les chances de toucher avec un sort une cible de niveau $4 de $3%',
