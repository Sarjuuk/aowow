...
class QuestFilter extends DBTypeFilter
{
    ...
    protected function cbItemChoices(int $cr, int $crs, string $crv) : ?array
    {
        ...
        $this->queryOpts['q']['s'][] = ', (IF(`rewardChoiceItemId1`, 1, 0) + IF(`rewardChoiceItemId2`, 1, 0) + IF(`rewardChoiceItemId3`, 1, 0) + IF(`rewardChoiceItemId4`, 1, 0) + IF(`rewardChoiceItemId5`, 1, 0) + IF(`rewardChoiceItemId6`, 1, 0)) AS "numChoices"';
        $this->queryOpts['q']['h'][] = '`numChoices` '.$crs.' '.$crv;
        return [1];
    }
    ...
    protected function cbItemRewards(int $cr, int $crs, string $crv) : ?array
    {
        ...
        $this->queryOpts['q']['s'][] = ', (IF(`rewardItemId1`, 1, 0) + IF(`rewardItemId2`, 1, 0) + IF(`rewardItemId3`, 1, 0) + IF(`rewardItemId4`, 1, 0)) AS "numRewards"';
        $this->queryOpts['q']['h'][] = '`numRewards` '.$crs.' '.$crv;
        return [1];
    }
