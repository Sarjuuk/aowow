...
abstract class Stat                                         // based on g_statToJson
{
    ...
    public const int MANA                  = 2;                 // note: mana is on idx 0 from 5.0 onwards; idx 2 is empty
    ...
    public const int RAGE                  = 9;
    public const int FOCUS                 = 10;
    public const int RUNIC_POWER           = 11;
    public const int DEFENSE_RTG           = 12;
    public const int DODGE_RTG             = 13;
    public const int PARRY_RTG             = 14;
    public const int BLOCK_RTG             = 15;
    public const int MELEE_HIT_RTG         = 16;
    public const int RANGED_HIT_RTG        = 17;
    public const int SPELL_HIT_RTG         = 18;
    public const int MELEE_CRIT_RTG        = 19;
    public const int RANGED_CRIT_RTG       = 20;
    public const int SPELL_CRIT_RTG        = 21;
    public const int MELEE_HIT_TAKEN_RTG   = 22;
    public const int RANGED_HIT_TAKEN_RTG  = 23;
    public const int SPELL_HIT_TAKEN_RTG   = 24;
    public const int MELEE_CRIT_TAKEN_RTG  = 25;
    public const int RANGED_CRIT_TAKEN_RTG = 26;
    public const int SPELL_CRIT_TAKEN_RTG  = 27;
    public const int MELEE_HASTE_RTG       = 28;
    public const int RANGED_HASTE_RTG      = 29;
    public const int SPELL_HASTE_RTG       = 30;
    public const int HIT_RTG               = 31;
    public const int CRIT_RTG              = 32;
    public const int HIT_TAKEN_RTG         = 33;
    public const int CRIT_TAKEN_RTG        = 34;
    public const int RESILIENCE_RTG        = 35;
    public const int HASTE_RTG             = 36;
    public const int EXPERTISE_RTG         = 37;
    public const int ATTACK_POWER          = 38;
    public const int RANGED_ATTACK_POWER   = 39;
    public const int FERAL_ATTACK_POWER    = 40;            // unused in wow-3.3.5
    public const int HEALING_SPELL_POWER   = 41;            // deprecated
    public const int DAMAGE_SPELL_POWER    = 42;            // deprecated
    public const int MANA_REGENERATION     = 43;
    public const int ARMOR_PENETRATION_RTG = 44;
    public const int SPELL_POWER           = 45;
    public const int HEALTH_REGENERATION   = 46;            // no differentiation between IC (item mods / spells) and OOC (from spirit) for Profiler
    public const int SPELL_PENETRATION     = 47;
    public const int BLOCK                 = 48;
 // public const int MASTERY_RTG           = 49;            // not in wow-3.3.5
    public const int ARMOR                 = 50;
    public const int FIRE_RESISTANCE       = 51;
    public const int FROST_RESISTANCE      = 52;
    public const int HOLY_RESISTANCE       = 53;
    public const int SHADOW_RESISTANCE     = 54;
    public const int NATURE_RESISTANCE     = 55;
    public const int ARCANE_RESISTANCE     = 56;
    public const int FIRE_SPELL_POWER      = 57;
    public const int FROST_SPELL_POWER     = 58;
    public const int HOLY_SPELL_POWER      = 59;
    public const int SHADOW_SPELL_POWER    = 60;
    public const int NATURE_SPELL_POWER    = 61;
    public const int ARCANE_SPELL_POWER    = 62;
    // v for stats lookups v
    public const int WEAPON_DAMAGE         = 200;           // +weapon dmg from enchantments
    public const int WEAPON_DAMAGE_TYPE    = 201;
    public const int WEAPON_DAMAGE_MIN     = 202;
    public const int WEAPON_DAMAGE_MAX     = 203;
    public const int WEAPON_SPEED          = 204;
    public const int WEAPON_DPS            = 205;           // also +weapon dps from enchantments (rockbiter)
    public const int MELEE_DAMAGE_MIN      = 206;
    public const int MELEE_DAMAGE_MAX      = 207;
    public const int MELEE_SPEED           = 208;
    public const int MELEE_DPS             = 209;
    public const int RANGED_DAMAGE_MIN     = 210;
    public const int RANGED_DAMAGE_MAX     = 211;
    public const int RANGED_SPEED          = 212;
    public const int RANGED_DPS            = 213;
    public const int EXTRA_SOCKETS         = 214;
    public const int ARMOR_BONUS           = 215;
    public const int MELEE_ATTACK_POWER    = 216;
    // v only seen in profiler v
    public const int EXPERTISE             = 500;
    public const int ARMOR_PENETRATION_PCT = 501;
    public const int MELEE_HIT_PCT         = 502;
    public const int MELEE_CRIT_PCT        = 503;
    public const int MELEE_HASTE_PCT       = 504;
    public const int RANGED_HIT_PCT        = 505;
    public const int RANGED_CRIT_PCT       = 506;
    public const int RANGED_HASTE_PCT      = 507;
    public const int SPELL_HIT_PCT         = 508;
    public const int SPELL_CRIT_PCT        = 509;
    public const int SPELL_HASTE_PCT       = 510;
    public const int MANA_REGENERATION_SPI = 511;           // mp5 from spirit, excluding other sources
    public const int MANA_REGENERATION_OC  = 512;           // mp5 out of combat, excluding other sources
    public const int MANA_REGENERATION_IC  = 513;           // mp5 in combat, excluding other sources
    public const int ARMOR_TOTAL           = 514;           // ARMOR + ARMOR_BONUS meta category .. can be skipped here like pet* stats?
    public const int DEFENSE               = 515;
    public const int DODGE_PCT             = 516;
    public const int PARRY_PCT             = 517;
    public const int BLOCK_PCT             = 518;
    public const int RESILIENCE_PCT        = 519;

    public const int FLAG_NONE        = 0x00;
    public const int FLAG_ITEM        = 0x01;               // found on items
    public const int FLAG_SERVERSIDE  = 0x02;               // not included in g_statToJson
    public const int FLAG_PROFILER    = 0x04;               // stat used in profiler only
    public const int FLAG_LVL_SCALING = 0x08;               // rating effectivenes scales with level
    public const int FLAG_FLOAT_VALUE = 0x10;               // not an int
    public const int FLAG_NO_WEIGHT   = 0x20;               // for item summary and filter .. basically any fi_filters.items of type: num thats not excluded by noweights: 1 is weightable

    public const int IDX_JSON_STR      = 0;
    public const int IDX_ITEM_MOD      = 1;                 // granted by items
    public const int IDX_COMBAT_RATING = 2;                 // granted by spells + enchantments
    public const int IDX_FILTER_CR_ID  = 3;                 // also references listview cols
    public const int IDX_FLAGS         = 4;
     ...
     */
    private static array $crPerPctPoint = array(
