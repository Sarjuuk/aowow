...
var mn_items = [
    [2,"武器",,[
        [,"单手武器",'?items=2&filter=ty=15:13:0:4:7'],
        [15,"匕首"],
        [13,"拳套"],
        [0,"单手斧"],
        [4,"单手锤"],
        [7,"单手剑"],
        [,"双手武器",'?items=2&filter=ty=6:10:1:5:8'],
        [6,"长柄武器"],
        [10,"法杖"],
        [1,"双手斧"],
        [5,"双手锤"],
        [8,"双手剑"],
        [,"远程武器",'?items=2&filter=ty=2:18:3:16:19'],
        [2,"弓"],
        [18,"弩"],
        [3,"枪"],
        [16,"投掷武器"],
    ...
    [4,"护甲",,[
        ...
        [1,"布甲",,[
            [5,"胸部","?items=4.1&filter=sl=5"],
            [8,"脚部","?items=4.1&filter=sl=8"],
            [10,"手部","?items=4.1&filter=sl=10"],
            [1,"头部","?items=4.1&filter=sl=1"],
            [7,"腿部","?items=4.1&filter=sl=7"],
            [3,"肩部","?items=4.1&filter=sl=3"],
            [6,"腰部","?items=4.1&filter=sl=6"],
            [9,"手腕","?items=4.1&filter=sl=9"]
        ]],
        [2,"皮甲",,[
            [5,"胸部","?items=4.2&filter=sl=5"],
            [8,"脚部","?items=4.2&filter=sl=8"],
            [10,"手部","?items=4.2&filter=sl=10"],
            [1,"头部","?items=4.2&filter=sl=1"],
            [7,"腿部","?items=4.2&filter=sl=7"],
            [3,"肩部","?items=4.2&filter=sl=3"],
            [6,"腰部","?items=4.2&filter=sl=6"],
            [9,"手腕","?items=4.2&filter=sl=9"]
        ]],
        [3,"锁甲",,[
            [5,"胸部","?items=4.3&filter=sl=5"],
            [8,"脚部","?items=4.3&filter=sl=8"],
            [10,"手部","?items=4.3&filter=sl=10"],
            [1,"头部","?items=4.3&filter=sl=1"],
            [7,"腿部","?items=4.3&filter=sl=7"],
            [3,"肩部","?items=4.3&filter=sl=3"],
            [6,"腰部","?items=4.3&filter=sl=6"],
            [9,"手腕","?items=4.3&filter=sl=9"]
        ]],
        [4,"板甲",,[
            [5,"胸部","?items=4.4&filter=sl=5"],
            [8,"脚部","?items=4.4&filter=sl=8"],
            [10,"手部","?items=4.4&filter=sl=10"],
            [1,"头部","?items=4.4&filter=sl=1"],
            [7,"腿部","?items=4.4&filter=sl=7"],
            [3,"肩部","?items=4.4&filter=sl=3"],
            [6,"腰部","?items=4.4&filter=sl=6"],
...
var mn_spells = [
    [,"Character"],
    [7,"职业技能",,[
        [6,"死亡骑士",,[[770,"鲜血",,,{tinyIcon:"Spell_Deathknight_BloodPresence"}],[771,"Frost",,,{tinyIcon:"Spell_Deathknight_FrostPresence"}],[772,"Unholy",,,{tinyIcon:"Spell_Deathknight_UnholyPresence"}],[776,"Runeforging"]],{className:"c6",tinyIcon:"class_deathknight"}],
        [11,"德鲁伊",,[[574,"Balance",,,{tinyIcon:"Spell_Nature_StarFall"}],[134,"Feral",,,{tinyIcon:"Ability_Racial_BearForm"}],[573,"Restoration",,,{tinyIcon:"Spell_Nature_HealingTouch"}]],{className:"c11",tinyIcon:"class_druid"}],
        [3,"猎人",,[[50,"Beast Mastery",,,{tinyIcon:"Ability_Hunter_BeastTaming"}],[163,"Marksmanship",,,{tinyIcon:"Ability_Marksmanship"}],[51,"Survival",,,{tinyIcon:"Ability_Hunter_SwiftStrike"}]],{className:"c3",tinyIcon:"class_hunter"}],
        [8,"法师",,[[237,"Arcane",,,{tinyIcon:"Spell_Holy_MagicalSentry"}],[8,"Fire",,,{tinyIcon:"Spell_Fire_FireBolt02"}],[6,"Frost",,,{tinyIcon:"Spell_Frost_FrostBolt02"}]],{className:"c8",tinyIcon:"class_mage"}],
        [2,"圣骑士",,[[594,"Holy",,,{tinyIcon:"Spell_Holy_HolyBolt"}],[267,"Protection",,,{tinyIcon:"Spell_Holy_DevotionAura"}],[184,"Retribution",,,{tinyIcon:"Spell_Holy_AuraOfLight"}]],{className:"c2",tinyIcon:"class_paladin"}],
        [5,"牧师",,[[613,"Discipline",,,{tinyIcon:"Spell_Holy_WordFortitude"}],[56,"Holy",,,{tinyIcon:"Spell_Holy_GuardianSpirit"}],[78,"Shadow Magic",,,{tinyIcon:"Spell_Shadow_ShadowWordPain"}]],{className:"c5",tinyIcon:"class_priest"}],
        [4,"潜行者",,[[253,"Assassination",,,{tinyIcon:"Ability_Rogue_Eviscerate"}],[38,"Combat",,,{tinyIcon:"Ability_BackStab"}],[39,"Subtlety",,,{tinyIcon:"Ability_Stealth"}]],{className:"c4",tinyIcon:"class_rogue"}],
        [7,"萨满祭司",,[[375,"Elemental Combat",,,{tinyIcon:"Spell_Nature_Lightning"}],[373,"Enhancement",,,{tinyIcon:"Spell_Nature_LightningShield"}],[374,"Restoration",,,{tinyIcon:"Spell_Nature_MagicImmunity"}]],{className:"c7",tinyIcon:"class_shaman"}],
        [9,"术士",,[[355,"Affliction",,,{tinyIcon:"Spell_Shadow_DeathCoil"}],[354,"Demonology",,,{tinyIcon:"Spell_Shadow_Metamorphosis"}],[593,"Destruction",,,{tinyIcon:"Spell_Shadow_RainOfFire"}]],{className:"c9",tinyIcon:"class_warlock"}],
        [1,"战士",,[[26,"Arms",,,{tinyIcon:"Ability_Rogue_Eviscerate"}],[256,"Fury",,,{tinyIcon:"Ability_Warrior_InnerRage"}],[257,"Protection",,,{tinyIcon:"INV_Shield_06"}]],{className:"c1",tinyIcon:"class_warrior"}]
    ]],
    [-13, "雕文",, [
        [6, "死亡骑士",, [[1, "主要", '?spells=-13.6&filter=gl=1'],[2, "次要", '?spells=-13.6&filter=gl=2']], {className:'c6', tinyIcon:'class_deathknight'}],
        [11, "德鲁伊",, [[1, "主要", '?spells=-13.11&filter=gl=1'],[2, "次要", '?spells=-13.11&filter=gl=2']], {className:'c11', tinyIcon:'class_druid'}],
        [3, "猎人",, [[1, "主要", '?spells=-13.3&filter=gl=1'],[2, "次要", '?spells=-13.3&filter=gl=2']], {className:'c3', tinyIcon:'class_hunter'}],
        [8, "Mage",, [[1, "主要", '?spells=-13.8&filter=gl=1'],[2, "次要", '?spells=-13.8&filter=gl=2']], {className:'c8', tinyIcon:'class_mage'}],
        [2, "Paladin",, [[1, "主要", '?spells=-13.2&filter=gl=1'],[2, "次要", '?spells=-13.2&filter=gl=2']], {className:'c2', tinyIcon:'class_paladin'}],
        [5, "Priest",, [[1, "主要", '?spells=-13.5&filter=gl=1'],[2, "次要", '?spells=-13.5&filter=gl=2']], {className:'c5', tinyIcon:'class_priest'}],
        [4, "Rogue",, [[1, "主要", '?spells=-13.4&filter=gl=1'],[2, "次要", '?spells=-13.4&filter=gl=2']], {className:'c4', tinyIcon:'class_rogue'}],
        [7, "Shaman",, [[1, "主要", '?spells=-13.7&filter=gl=1'],[2, "次要", '?spells=-13.7&filter=gl=2']], {className:'c7', tinyIcon:'class_shaman'}],
        [9, "Warlock",, [[1, "主要", '?spells=-13.9&filter=gl=1'],[2, "次要", '?spells=-13.9&filter=gl=2']], {className:'c9', tinyIcon:'class_warlock'}],
        [1, "Warrior",, [[1, "主要", '?spells=-13.1&filter=gl=1'],[2, "次要", '?spells=-13.1&filter=gl=2']], {className:'c1', tinyIcon:'class_warrior'}]
    ]],
    [-11,"Proficiencies",, [
        [8,"Armor"],
        [6,"Weapon"],
    ...
    [-4,"Racial Traits"],
    [-2,"Talents",,[
        [6,"死亡骑士",,[[770,"Blood",,,{tinyIcon:"Spell_Deathknight_BloodPresence"}],[771,"Frost",,,{tinyIcon:"Spell_Deathknight_FrostPresence"}],[772,"Unholy",,,{tinyIcon:"Spell_Deathknight_UnholyPresence"}]],{className:"c6",tinyIcon:"class_deathknight"}],
        [11,"德鲁伊",,[[574,"Balance",,,{tinyIcon:"Spell_Nature_StarFall"}],[134,"Feral",,,{tinyIcon:"Ability_Racial_BearForm"}],[573,"Restoration",,,{tinyIcon:"Spell_Nature_HealingTouch"}]],{className:"c11",tinyIcon:"class_druid"}],
        [3,"猎人",,[[50,"Beast Mastery",,,{tinyIcon:"Ability_Hunter_BeastTaming"}],[163,"Marksmanship",,,{tinyIcon:"Ability_Marksmanship"}],[51,"Survival",,,{tinyIcon:"Ability_Hunter_SwiftStrike"}]],{className:"c3",tinyIcon:"class_hunter"}],
...
var mn_factions = [
    ...
    [980,"燃烧的远征",,[[936,"Shattrath City"]]],
    [1097,"巫妖王之怒",,[[1037,"Alliance Vanguard"],[1052,"Horde Expedition"],[1117,"Sholazar Basin"]]],
    [0,"其它"]
];
var mn_pets = [
...
var mn_database = [
    ...
    [0,"物品","?items",mn_items],
    [2,"职业套装","?itemsets",mn_itemSets],
    [4,"生物","?npcs",mn_npcs],
    [5,"物件","?objects",mn_objects],
    [8,"猎人宠物","?pets",mn_pets],
    [14,"技能","?skills",mn_skills],
...
var mn_community = [
    [3,"Forum","/snet",null,{tinyIcon: g_staticUrl + "/images/icons/forum.png"}],
...
var LANG = {
    ...
    lvnote_tryfiltering: "尝试 <a>过滤</a> 你的结果",
    ...
    lvnote_achievementsfound: "$1 成就找到 ($2 显示)",
    ...
    lvnote_itemdropsinnormalonly:   "此物品仅在普通模式下掉落。",
    lvnote_itemdropsinheroiconly:   "此物品仅在英雄模式下掉落。",
    lvnote_itemdropsinnormalheroic: "此物品在普通和英雄模式下掉落。",
    lvnote_itemdropsinnormal10only: "此物品仅在10人普通模式下掉落。",
    lvnote_itemdropsinnormal25only: "此物品仅在25人普通模式下掉落。",
    lvnote_itemdropsinheroic10only: "此物品仅在10人英雄模式下掉落。",
    lvnote_itemdropsinheroic25only: "此物品仅在25人英雄模式下掉落。",
    ...
    tooltip_loading:                   "正在加载...",
    tooltip_lvheader1:                 "点击排序",
    tooltip_lvheader2:                 "右击过滤",
    tooltip_lvheader3:                 "点击过滤",
    ...
    tooltip_reqenchanting:             "需要Enchanting技能",
    tooltip_reqinscription:            "需要Inscription skill",
    tooltip_reqjewelcrafting:          "需要珠宝加工技能",
    tooltip_reqlevel:                  "需要等级",
    tooltip_reqlockpicking:            "需要Lockpicking skill",
    ...
    tab_heroicdrops:         "英雄模式掉落",
    tab_heroicXdrops:        "英雄 $1 掉落",
    tab_heroic:              "英雄",
    tab_heroicX:             "英雄 $1",
    tab_holidays:            "世界事件",
    tab_info:                "信息",
    ...
    tab_mounts:              "坐骑",
    tab_normaldrops:         "普通模式掉落",
    tab_normalXdrops:        "普通 $1 模式掉落",
    tab_normal:              "普通",
    tab_normalX:             "普通 $1",
    ...
    mapper_tippin:   "提示：点击地图添加/删除坐标点",
    mapper_hidepins: "隐藏坐标点",
    mapper_showpins: "显示坐标点",
    ...
    fidropdowns: {
        ...
        faction:        [
                            ...
                            [47, "铁炉堡"],                      [989, "Keepers of Time"],               [1090, "Kirin Tor"],                    [1098, "Knights of the Ebon Blade"],    [978, "Kurenai"],
        ...
        zone:           [
                            ...
                            [4812, "Icecrown Citadel"],             [1537, "铁炉堡"],                    [4710, "Isle of Conquest"],             [4080, "Isle of Quel'Danas"],           [3457, "Karazhan"],
                            ...
                            [4603, "阿尔卡冯的宝库"],            [718, "Wailing Caverns"],               [3277, "Warsong Gulch"],                [28, "Western Plaguelands"],            [40, "Westfall"],
        ...
        multimoderaid:  [
                            ...
                            [4722, "Trial of the Crusader"],        [4273, "Ulduar"],                       [4603, "阿尔卡冯的宝库"],            [4987, "The Ruby Sanctum"]
                        ],
        event:          [
        ...
        glyphtype:      [   [1, "主要"],                           [2, "次要"]                            ],
        classs:         [
                            [12, "Any"],                            [6, "死亡骑士"],                    [11, "德鲁伊"],                          [3, "猎人"],                          [8, "Mage"],
