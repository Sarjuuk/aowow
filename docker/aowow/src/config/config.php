...
$AoWoWconf['aowow'] = array (
    'host' => getenv('DB_AOWOW_HOST') . ':' .  getenv('DB_AOWOW_PORT'), // 'localhost:3306'
...
$AoWoWconf['world'] = array (
    'host' => getenv('DB_WORLD_HOST') . ':' . getenv('DB_WORLD_PORT'), // 'localhost:3306'
...
$AoWoWconf['auth'] = array (
    'host' => getenv('DB_AUTH_HOST') . ':' . getenv('DB_AUTH_PORT'), // 'localhost:3306'
...
$AoWoWconf['characters']['1'] = array (
    'host' => getenv('DB_CHARACTERS_1_HOST') . ':' . getenv('DB_CHARACTERS_1_PORT'),  // 'localhost:3306'
